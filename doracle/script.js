...
class QuantumOracle {
    constructor() {
        this.responseTemplates = {
            ...
            future: {
                positive: [
                    "БУДУЩЕЕ СИЯЕТ ЯРКИМИ КРАСКАМИ - ВАС ЖДЁТ УСПЕХ",
                    "ВСЁ СЛОЖИТСЯ ЛУЧШИМ ОБРАЗОМ - ДОВЕРЬТЕСЬ СУДЬБЕ",
                    "СВЕТЛАЯ ПОЛОСА НЕЗАДОЛГО - ПРИГОТОВЬТЕСЬ К РАДОСТИ",
                    "ЖИЗНЬ ПРЕПАРУЕТ ПРИЯТНЫЕ СЮРПРИЗЫ",
                    "ПУТЬ ОСВЕТИТСЯ ЯСНЫМ СВЕТОМ - СМЕЛО ДВИГАЙТЕСЬ ВПЕРЁД",
                    "СУДЬБА ГОТОВИТ ДЛЯ ВАС ЧТО-ТО ОСОБЕННОЕ",
                    "ВСЕ ДОРОГИ ВЕДУТ К СЧАСТЬЮ - ВЫБИРАЙТЕ ЛЮБУЮ"
                ],
                neutral: [
                    "БУДУЩЕЕ ТКАНЕТ СЛОЖНЫЙ УЗОР - БУДЬТЕ ВНИМАТЕЛЬНЫ",
                    "ПУТЬ ИЗВИЛИСТ - НО ОН ПРИВЕДЁТ К ЦЕЛИ",
                    "СУДЬБА ЛЮБИТ ЗАГАДКИ - ПРИНИМАЙТЕ ИХ КАК ВЫЗОВ",
                    "БУДУЩЕЕ ГИБКО - ВАШИ ДЕЙСТВИЯ ЕГО ФОРМИРУЮТ",
                    "ВСЕ ВОЗМОЖНОСТИ ОТКРЫТЫ - ВЫБОР ЗА ВАМИ",
                    "ЖИЗНЬ - ЭТО ПУТЕШЕСТВИЕ С НЕИЗВЕСТНЫМ МАРШРУТОМ"
                ]
            }
        };
        ...
        this.themeKeywords = {
            relationships: [
                // Основные
                'отношен', 'любов', 'встреч', 'парень', 'девуш', 'семь', 'брак', 'чувств', 
                'сердц', 'роман', 'свидан', 'знакомств', 'измен', 'расставан',
                // Дополнительные
                'встречу', 'познаком', 'любим', 'симпот', 'нрав', 'целов', 'обня', 
                'секс', 'интим', 'близость', 'семей', 'дети', 'ребен', 'муж', 'жена',
                'супруг', 'невест', 'жених', 'влюб', 'романт', 'свиданк', 'датинг',
                'тinder', 'баб', 'телок', 'мужик', 'девок', 'парней', 'отношки',
                'любовник', 'любовница', 'измен', 'ревность', 'доверие', 'верность',
                // Вопросы
                'выйду замуж', 'женюсь', 'встречу любовь', 'найду пару', 'будут дети',
                'сколько парней', 'сколько девушек', 'когда встречу', 'когда женюсь'
            ],
            ...
            money: [
                ...
                // Дополнительные
                'зарплат', 'зарплату', 'зарабат', 'прибыл', 'выручк', 'капитал',
                'состояние', 'благосостояние', 'денег', 'бабки', 'бабли', 'лавэ',
                'грош', 'копейк', 'средств', 'финанс', 'экономи', 'трат', 'потрач',
                'покуп', 'продаж', 'бизнес', 'предприниматель', 'стартап', 'проект',
                'акци', 'акций', 'крипт', 'биткоин', 'инвестиц', 'вложен',
                'ипотек', 'ипотека', 'займ', 'долг', 'долгов', 'кредитов',
                // Вопросы
                'сколько денег', 'сколько заработа', 'какой доход', 'когда разбогатею',
                'когда куплю', 'смогу купить', 'хватит денег', 'буду богат'
            ],
            ...
            career: [
                ...
                // Дополнительные
                'работу', 'работать', 'труд', 'деятельность', 'професси', 'специальност',
                'должность', 'позиц', 'ваканс', 'трудоустрой', 'интервью', 'собеседован',
                'начальств', 'руковод', 'директор', 'босс', 'шеф', 'коллектив',
                'сотрудник', 'команд', 'проект', 'задач', 'обязанност', 'функц',
                'карьерн', 'продвижен', 'рост', 'развити', 'успех', 'достижен',
                'увольнен', 'уволюсь', 'сменю работ', 'поиск работ', 'работа мечт',
                // Вопросы
                'когда повышение', 'когда устроюсь', 'сменю работу', 'карьерный рост',
                'работа мечты', 'когда начальник', 'открою бизнес'
            ],
            ...
            health: [
                ...
                // Дополнительные
               'здоровье', 'болезнь', 'заболеван', 'простуда', 'грипп', 'коронавирус',
                'ковид', 'температур', 'кашель', 'насморк', 'горло', 'голов', 'живот',
                'спина', 'сустав', 'давлен', 'сердце', 'легк', 'печен', 'почк',
                'желудок', 'кишечн', 'нерв', 'псих', 'депресс', 'стресс', 'тревож',
                'бессонниц', 'сон', 'усталост', 'энерг', 'сил', 'бодрост',
                'фитнес', 'спорт', 'трениров', 'зал', 'бег', 'йог', 'плаван',
                'диет', 'питани', 'еда', 'продукт', 'вес', 'похуден', 'набор веса',
                'витамин', 'лекарств', 'таблет', 'укол', 'операц', 'больничн',
                // Вопросы
                'когда выздоровею', 'сколько проживу', 'буду здоров', 'когда похудею',
                'когда поправлюсь', 'избавлюсь от болезни'
            ],
    
            personal: [
                // Основные
                'развити', 'потенциал', 'талант', 'способност', 'умени', 'навык', 
                'саморазвити', 'обучени', 'образовани',
                // Дополнительные
                'личность', 'характер', 'темперамент', 'привычк', 'привычки',
                'уверенност', 'неуверенност', 'комплекс', 'страх', 'фоби',
                'цель', 'мечт', 'желан', 'амбиц', 'стремлен', 'мотивац',
                'успех', 'неудач', 'провал', 'ошибк', 'опыт', 'урок',
                'изменен', 'трансформац', 'преображен', 'рост', 'эволюц',
                'творчеств', 'креатив', 'вдохновен', 'иде', 'проект',
                'хобби', 'увлечен', 'интерес', 'умею', 'могу', 'способен',
                'сильн', 'слаб', 'достоинств', 'недостатк', 'плюс', 'минус',
                // Вопросы
                'когда изменюсь', 'раскрою талант', 'найду себя', 'когда научусь',
                'когда добьюсь', 'реализую мечту', 'когда стану лучше'
            ],
    
            future: [
                'будущ', 'судьб', 'предназначен', 'смысл', 'мисси',
                'жизн', 'путь', 'дорог', 'след', 'направлен',
                'успех', 'неудач', 'везен', 'удач', 'везет',
                'счаст', 'радост', 'горе', 'печал', 'груст',
                'надежд', 'вера', 'доверие', 'риск', 'шанс',
                'возможност', 'перспектив', 'план', 'цель', 'мечт',
                'изменен', 'перемен', 'новое', 'неизвестн', 'тайна',
                // Вопросы
                'что будет', 'что ждет', 'что меня ждет', 'как сложится',
                'как будет', 'что произойдет', 'когда наступит', 'когда случится',
                'скоро ли', 'долго ли', 'когда закончится', 'когда начнется'
            ]
        };
